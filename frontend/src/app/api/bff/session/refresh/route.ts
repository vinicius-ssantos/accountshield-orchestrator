...
import { handleSessionRefreshRequest, type SessionTokenService } from "@/server/bff/session/session";
...
export async function POST(request: Request): Promise<Response> {
  return handleSessionRefreshRequest(request, configuredService());
}
