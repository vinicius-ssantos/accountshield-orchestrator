...
| API authentication and RBAC | **Partial** | A stateless JWT resource server and backend-enforced roles protect sensitive APIs, including the decision-investigation read contract; remaining issue #19 acceptance and documentation alignment still need closure | ADR 0011; [#19](https://github.com/vinicius-ssantos/accountshield-orchestrator/issues/19) |
