...
| [0037](0037-privacy-minimized-decision-investigation-read-api.md) | Accepted | Persist bounded correlation metadata and expose an authorized, privacy-minimized decision-search/read model with body-based filters, keyset pagination, `no-store`, and no raw audit projection | Issues #69 and #134 |
